...
static void test_put_11(void)
{
    ...
    TestAssertNotEq(api_name, 1, NULL, msgq_id);
    {
        ...
        (void)osThreadNew(test_put_task_callback1, msgq_id, NULL);
        osDelay(10);
...
static void test_put_12(void)
{
    ...
    TestAssertNotEq(api_name, 1, NULL, msgq_id);
    {
        ...
        (void)osThreadNew(test_put_task_callback1, msgq_id, NULL);
        osDelay(1000);
        (void)osThreadNew(test_put_task_callback2, msgq_id, NULL);
        osDelay(1000);
...
static void test_put_13(void)
{
    ...
    TestAssertNotEq(api_name, 1, NULL, msgq_id);
    {
        ...
        (void)osThreadNew(test_put_task_callback2, msgq_id, NULL);
        osDelay(10);
        (void)osThreadNew(test_put_task_callback3, msgq_id, NULL);
        osDelay(10);
...
static void test_get_01(void)
{
    ...
    TestAssertNotEq(api_name, 1, NULL, msgq_id);
    {
        ...
        (void)osThreadNew(test_get_01_task_callback, msgq_id, NULL);
        osDelay(10);
...
static void test_get_10(void)
{
    ...
    TestAssertNotEq(api_name, 1, NULL, msgq_id);
    {
        ...
        (void)osThreadNew(test_get_10_task_callback, msgq_id, NULL);
        osDelay(1000);
...
static void test_get_11(void)
{
    ...
    TestAssertNotEq(api_name, 1, NULL, msgq_id);
    {
        ...
        (void)osThreadNew(test_get_task_callback1, msgq_id, NULL);
        osDelay(10);
        (void)osThreadNew(test_get_task_callback2, msgq_id, NULL);
        osDelay(10);
...
static void test_get_12(void)
{
    ...
    TestAssertNotEq(api_name, 1, NULL, msgq_id);
    {
        ...
        (void)osThreadNew(test_get_task_callback2, msgq_id, NULL);
        osDelay(10);
        (void)osThreadNew(test_get_task_callback3, msgq_id, NULL);
        osDelay(10);
